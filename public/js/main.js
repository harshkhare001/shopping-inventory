...
//   li.appendChild(div2);
//   list.appendChild(li);
//   const res = await axios.post("https://crudcrud.com/api/5acd443d6ef54ec3bb6ce76626383c4e/storeData",data);
//   id = res.data._id;
...
list.addEventListener("click", async (e) => {
  if (e.target.classList.contains("buy1") || e.target.classList.contains("buy2") || e.target.classList.contains("buy3")) {
    ...
    await axios.put(`http://localhost:3000/updateProduct/${id}`,data);
